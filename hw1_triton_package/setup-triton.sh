...
# =========================
echo ">>> Installing Triton stack (torch, numpy, triton, cupy, scipy, transformers, HF/audio runtime deps)"
ask_continue "Install Python packages needed for checks and benchmarks?"

pip install --upgrade pip
pip install torch numpy triton cupy-cuda12x datasets scipy transformers huggingface_hub accelerate safetensors soundfile
